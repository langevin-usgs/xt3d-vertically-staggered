...
\noindent {\color{red} Methods Brief/}
...
\noindent{\color{red} \textit{\break Note to editor: removed all section numbers}}
...
% Bardot et al. (2023) changed from live ref to text to allow \sout
...
% Reilly and Harbaugh, 2004 changed from live link to text to enable \sout
...
\noindent{\color{red} \textit{\break Note to editor: changed heading "Bibliography" to "References".}}

\noindent{\color{red} \textit{Note to editor: implemented Harvard style for references.}}

\noindent{\color{red} \textit{Note to editor: colors and symbols in the figures were modified to improve accessibility for colorblind readers.}}
